                    ...
                    <div class="col-md-12" style="">
                        ...
                        <div class="log-sign-right-sec-wrapper">
                            ...
                            if (!isset($_SESSION['cus_id'])) {
                                echo '<a href="login.php"><label class="logon_pnl" style="color:#3E1818; font-size: 23px; border: 2px solid black; " >log in  &nbsp;&nbsp;</label></a><span style=" border-left: 2px solid red; "></span>';
                                echo '<a href="register.php"><label style="color:#3E1818; font-size: 23px; border: 2px solid black;">Create account</label></a>';
                            } else {
                    ...
                    <div class="col-md-12 menu-mid-sec-inner-wrapper">
                        ...
                        <div class="topmenu-righticons-sec-wrapper">
                            <span class="topmenu-cart-icon-sec-wrapper">
                                ...
                                <?php
                                if (!isset($_SESSION['cus_id'])) {
                                    echo '<a href="cart_item.php"><i style="font-size:56px; color:blue;" class="fa fa-shopping-cart" aria-hidden="true"></i><span class="items-num-wrapper item_tot" ></span></a>';
                                } else {
                        ...
                        <div class="topmenu-righticons-sec-wrapper">
                            <span class="topmenu-cart-icon-sec-wrapper">
                                ...
                                if (!isset($_SESSION['cus_id'])) {
                                    ...
                                    echo '<a href="user_profil.php"> <i class="fa fa-shopping-cart" style="font-size: 60px; color:blue;" aria-hidden="true"></i>  <span class="items-num-wrapper itm_qty_user_log"></span></a>';
                    ...
                    <div class="container">
                        <div class="row">
                            <div class=" col-lg-12 " style="">
                                <span class="col-lg-4"> 
                                    ...
                                    if (!isset($_SESSION['cus_id'])) {
                                        echo '<a href = "login.php">
                                            <span style = "color:blue; font-size: 25px; font-weight:bold; text-align: left; color: #000000; border: 4px solid red;" >Login</span>
                                            </a>
                                            &nbsp;
                                            <span style = "border-left: 1px solid blue;height: 1px; "> &nbsp;
                                            </span>
                                            <a href = "register.php">
                                            <span style = "color:red; font-size: 25px; font-weight:bold; text-align: left; color: #000000; border: 4px solid red;" >Create Account</span>
                                            </a>';
                                    } else {
                                        $cus_name = $_SESSION['uname'];
                                        echo '<button type="button" style="margin:2px;  background-color: #5d5df3e3;" class="btn btn-primary btn-md" value = ' . $cus_name . ' id = "profil">My Profile</buttn>';
                                ...
                                <span class="col-lg-8" style="color:red; font-size: 20px; font-weight:bold; text-align: right; background: #fdff6e;" ><a href="user_profil.php">Order (LKR) = <span class="item_tot_price"></span></a></span>
