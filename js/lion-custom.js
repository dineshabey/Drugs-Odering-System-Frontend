$(document).ready(function () {
    ...
    $(window).scroll(function () {
        ...
        if (scroll_menu_to_sec > 23) {
            ...
            $(".menu-mid-sec-inner-wrapper").css({"padding-bottom":"0"});
            ...
            $(".log_cr_mob_sec_wrap").addClass('hide_top_sec_main_menu');
            ...
            $(".menu-mid-sec-inner-wrapper").css({"padding-bottom":"15px"});
            ...
            $(".log_cr_mob_sec_wrap").removeClass('hide_top_sec_main_menu');
        }
