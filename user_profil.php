                                    ...
                                    <span style="text-align: center;">
                                        <div class="card" style="border-style: outset; border-radius: 5px; background-color: #ffffff;  border-color:gold;">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <button type="button" class="btn btn-info table_font_size" id="process_order"> PROCESS ORDER</button>
                                                <hr>
                                            </div>
                                        </div>
                                    </span>
                    ...
                    function load_user_added_item() {
                        ...
                        $.post("./loaddata.php", {action: 'load_user_added_item'}, function (e) {
                            if (e === undefined || e.length === 0 || e === null) {
                                ...
                                $.each(e, function (index, qData) {
                                    index++;
                                    tableData += '<tr class="table_font_size">';
                                    tableData += '<td width="">' + index + '</td>';
...
//                                    tableData += '<td width=""> ' + qData.item_name + ' </td>';
                                ...
                                tableData += '<tr><td colspan="9" ><a href="index.php"><button type="button" class="btn btn-success table_font_size">< KEEP SHOPPING</button></a></td></tr>';
                            }
