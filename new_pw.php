...
if (!isset($_SESSION['cus_id_pw_recover'])) {
    echo $_SESSION['cus_id_pw_recover'];
    ...
    <body>
        ...
        <div class="container" style="padding-top: 50px;">
            ...
            <div class="form-horizontal" style="text-align: center;">
                <fieldset>
                    <!-- Form Name -->
                    <legend class=""><h4 class="table_font_size" style="color:black; font-weight: 500;">GENERATE CODE</h4></legend>

                    <!-- Password input-->
                    <div class="form-group">
                        <label class="col-md-4 control-label table_font_size" for="passwordinput">Enter new password </label>
                        <div class="col-md-4">
                    ...
                    <div class="form-group">
                        <label class="col-md-4 control-label table_font_size" for="passwordinput">Confirm new Password </label>
                        <div class="col-md-4">
